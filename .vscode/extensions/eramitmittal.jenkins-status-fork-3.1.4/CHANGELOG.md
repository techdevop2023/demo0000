...
- Updated `.jenkins` example in README (Thanks to @kimitaka [PR [#31](https://github.com/eramitmittal/vscode-jenkins-status/issues/31)](https://github.com/alefragnani/vscode-jenkins-status/pull/31))

## [3.1.0] - 2019-01-18
### Added
- Status Bar improvements (Thanks to @LinuxSuRen [PR [#29](https://github.com/eramitmittal/vscode-jenkins-status/issues/29)](https://github.com/alefragnani/vscode-jenkins-status/pull/29))
